...
public class BattleSystem : MonoBehaviour
{
    ...
    IEnumerator PlayerMove()
    {
        ...
        // If the battle state was not changed by RunMove, then go to next steps
    ...
    {
        bool canMove = sourceUnit.Pokemon.OnBeforeTurn();
        if (!canMove)
        {
    ...
    IEnumerator ShowDamageDetails(DamageDetails damageDetails)
    {
        ...
        if (damageDetails.TypeEffectiveness > 1)
            ...
            yield return dialogBox.TypeDialog("Nothing happened!");
    }
